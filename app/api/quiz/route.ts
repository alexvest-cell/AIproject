...
const BLOCK_RULES: Array<{ role: string; codes: string[]; block: string[] }> = [
    { role: 'student', codes: ['math_s', 'math_solve', 'math_learn', 'math_practice'],
      block: ['AI Video', 'AI Audio', 'Development', 'Marketing', 'Sales & CRM', 'Automation', 'Design', 'AI Image Generation'] },
    { role: 'student', codes: ['essays', 'ess_draft', 'ess_proof', 'ess_research'],
      block: ['AI Video', 'AI Audio', 'Development', 'Marketing', 'Sales & CRM', 'Automation'] },
    { role: 'student', codes: ['stu_notes', 'stu_flash', 'stu_summarise', 'stu_tutor'],
      block: ['AI Video', 'AI Audio', 'Development', 'Marketing', 'Sales & CRM', 'Automation', 'Design'] },
    { role: 'student', codes: ['research_s'],
      block: ['AI Video', 'AI Audio', 'Development', 'Marketing', 'Sales & CRM', 'Automation'] },
    { role: 'student', codes: ['code_s'],
      block: ['AI Video', 'AI Audio', 'Marketing', 'Sales & CRM', 'Design', 'AI Image Generation'] },
    ...
    { role: 'developer', codes: ['code_editor', 'vs_code', 'browser_build', 'automation_d', 'frontend', 'code_s'],
      block: ['AI Audio', 'AI Video', 'AI Image Generation', 'Marketing', 'Sales & CRM', 'Education', 'Data Analysis'] },
